...
class MinisterioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ministerios.index')->with('mensaje','Ministerio Registrado Correctamente');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ministerios.index')->with('mensaje','Se actualizo los datos correctamente');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('ministerios.index')->with('mensaje','Se elimino al Ministorio Correctamente');
