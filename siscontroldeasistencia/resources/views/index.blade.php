        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="small-box bg-info" style="height: 160px">
                    ...
                    <a href="{{url('ministerios')}}" class="small-box-footer" style="margin-top: 15px">Mas Detalles <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="small-box bg-warning" style="height: 160px">
                    ...
                    <a href="{{url('miembros')}}" class="small-box-footer" style="margin-top: 15px">Mas Detalles <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="small-box bg-success" style="height: 160px">
                    ...
                    <a href="{{url('usuarios')}}" class="small-box-footer" style="margin-top: 15px">Mas Detalles <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>


            <div class="col-lg-3">
                <div class="small-box bg-purple" style="height: 160px">
                    <div class="inner">
                    ...
                    <a href="{{url('asistencias')}}" class="small-box-footer" style="margin-top: 15px">Mas Detalles <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
