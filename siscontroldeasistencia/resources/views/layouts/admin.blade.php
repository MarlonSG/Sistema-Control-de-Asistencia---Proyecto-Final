...
<div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    ...
                    <!-- PONER USUARIO DE LA BASE DE DATOS -->
                    <!-- AUTH POSIBLEMENTE BORRAR SI ES QUE BORRAS EL REGISTRO DE SESION ACTUAL -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2023 - 2024 <a href="https://www.python.org">Marlon Salazar</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
